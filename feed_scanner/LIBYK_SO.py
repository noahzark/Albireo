...
class LIBYK_SO(AbstractScanner):
    ...
    def __init__(self, bangumi, episode_list):
        ...
        query_dict = json.loads(bangumi.libyk_so)
        search_query = urllib.urlencode(query_dict)
        self.feed_url = 'https://utils.libyk.so/torrent/rss?m=magnet&{0}'.format(search_query)
